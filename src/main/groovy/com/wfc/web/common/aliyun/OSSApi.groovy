...
class OSSApi {
    ...
    static boolean putObject(String bucketName, String filename, InputStream is, long length) throws Exception {
        //服务器端生成url签名字串
        OSSClient Server = new OSSClient(OSSConstants.ENDPOINT, OSSConstants.KEY, OSSConstants.SECRET);
        ...
        //客户端使用使用url签名字串发送请求
        OSSClient client = new OSSClient(OSSConstants.ENDPOINT, OSSConstants.KEY, OSSConstants.SECRET);
        // 添加PutObject请求头
